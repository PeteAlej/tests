...
PWM1
    CALL    SET_AN0	    ; SET AN0 CHANNEL
    CALL    DELAY
    BSF	    ADCON0,GO
CHECKADC:
    BTFSC   ADCON0,GO	    ; VERIFICA SI CONVERSION YA FINALIZÛ
    GOTO    CHECKADC	    ; NO? VOLVER A CHEQUEAR
    MOVF    ADRESH,W	    
    MOVWF   CONVERSION	    ; MOVER ADRESH A W Y LUEGO A VARIABLE CONVERSION
    BCF	    PIR1,ADIF	    ; VACIAR FLAG DE ADC
CHECK_TX:
    BTFSS   PIR1,TXIF
    GOTO    CHECK_TX
;    RRF	    CONVERSION,F
;    RRF	    CONVERSION,W
    ...
    GOTO    $-1
CHECK_RX:
    BTFSS   PIR1,RCIF	    ; VERIFICAR FLAG DE RECIBIDO
    GOTO    CHECK_RX	    ; FLAG NO SET? VERIFICAR EL TX
;    MOVF    RCREG,W
    RRF	    RCREG,F
    RRF	    RCREG,F
    RRF	    RCREG,W
...
CONFIG_PWM1
    ...
    BANKSEL CCP1CON
    BCF	    CCP1CON,P1M1
    BCF	    CCP1CON,P1M0	; SINGLE OUTPUT
    BSF	    CCP1CON,CCP1M3
    BSF	    CCP1CON,CCP1M2
    BCF	    CCP1CON,CCP1M1
    BSF	    CCP1CON,CCP1M0	; PWM MODE, P1A,P1C ACTIVE-HIGH, P1B,P1D ACTIVE-LOW
...
CONFIG_PWM2
    ...
    MOVWF   CCPR2L
    BSF	    CCP2CON, DC2B1
    BCF	    CCP2CON, DC2B0	    ; LSB del duty cicle
